...
The program takes with CIN an SOP expression, using the convention that each English letter is a variable and that lowercase letters are the inversion of the same 
